...
const Login = () => {
    ...
    const { setLoading, signInUser, setUser, signInWithGoogle, signInWithFacebook } = useContext(AuthContext);
        ...
        <section className="grid place-items-center m-6">
            ...
            <div className="w-full max-w-md p-8 space-y-3 rounded-xl bg-base-200 border">
                ...
                <div className="my-6 space-y-4">
                    ...
                    <button onClick={handleFacebookSignIn} aria-label="Login with Facebook" role="button" className="flex items-center justify-center w-full p-4 space-x-4 border rounded-md focus:ring-2 focus:ring-offset-1 border-gray-600 focus:ring-violet-600">
